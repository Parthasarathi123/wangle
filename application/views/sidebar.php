                ...
                <ul class="nav">
                    ...
                    <li class="submenu"><a href="#">
                            <i class="glyphicon glyphicon-calendar">
                                ...
                                <ul>
                             <li><a href="<?php echo site_url('admin/add_project');?>">Assign Projects</a></li>
                            <li><a href="<?php echo site_url('admin/home/view_project');?>">View Projects</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="submenu">
                         ...
                         <ul>
                            ...
                            <li><a href="<?php echo site_url('admin/home/delete');?>">Delete employee</a></li>
                        </ul>
                    </li>
                </ul>
                     </div>
